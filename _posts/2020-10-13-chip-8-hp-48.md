...
To run a CHIP-8 game, first press the white top-row button (labelled A–F) underneath the game you want to run. This will push that variable onto the stack, and it should appear at level 1.
